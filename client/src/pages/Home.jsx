...
const Home = () => {
  ...
  const statsData = [
    ...
    { 
      icon: Users, 
      value: loading ? '...' : `${stats.activeLearners || 0}+`, 
      label: 'Active Learners' 
    },
    { 
      icon: Trophy, 
      value: loading ? '...' : `${stats.categories || 50}+`, 
      label: 'Categories' 
    },
    { 
      icon: Zap, 
  ...
  return (
    <div className="space-y-20 pb-12">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-500">
              <span className="flex items-center gap-2">
                ...
                <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                <span className="ml-2 text-gray-400">{stats.activeLearners || 0}+ learners</span>
              </span>
      ...
      {/* ============================================
      STATS SECTION - Now with real-time data
      ============================================ */}
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-xl mx-auto">
              Join {stats.activeLearners || 0} learners and start mastering new topics today. It's completely free!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                whileHover={{ scale: 1.05, y: -2 }}
