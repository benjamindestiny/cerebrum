      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 bg-[#2D2D5E] rounded-lg border ${
                errors.schoolName ? 'border-red-500' : 'border-white/10'
              } text-white placeholder-gray-500 focus:border-[#6C2BD9] focus:outline-none`}
            />
          </div>
          {errors.schoolName && (
            <p className="text-red-400 text-xs mt-1">{errors.schoolName}</p>
          )}
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-4 py-3 bg-[#2D2D5E] rounded-lg border border-white/10 text-white placeholder-gray-500 focus:border-[#6C2BD9] focus:outline-none"
          >
          ...
          {errors.schoolType && (
            <p className="text-red-400 text-xs mt-1">{errors.schoolType}</p>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="City"
              className={`w-full px-4 py-3 bg-[#2D2D5E] rounded-lg border ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Phone"
                className="w-full pl-10 pr-4 py-3 bg-[#2D2D5E] rounded-lg border border-white/10 text-white placeholder-gray-500 focus:border-[#6C2BD9] focus:outline-none"
              />
            </div>
          </div>
          <div>
    ...
    return (
      <div className="space-y-4">
        <div>
          ...
          {errors.adminName && (
            <p className="text-red-400 text-xs mt-1">{errors.adminName}</p>
          )}
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 max-h-48 overflow-y-auto">
            {gradeLevels.map(grade => (
              <label key={grade} className="flex items-center gap-2 p-2 rounded-lg hover:bg-white/5 cursor-pointer">
                <input
                  type="checkbox"
                  value={grade}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {plans.map(plan => (
              ...
              >
                ...
                <div className="text-2xl font-bold text-[#6C2BD9]">{plan.price}</div>
      ...
      <div className="glass-card p-8 max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-3">
            <School className="w-12 h-12 text-[#6C2BD9]" />
            <h1 className="text-2xl font-bold text-white">School Sign Up</h1>
          </div>
