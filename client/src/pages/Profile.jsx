...
const Profile = () => {
  ...
  const loadProfile = async () => {
    ...
    try {
      ...
      // Get quiz results to calculate accurate stats
      ...
      if (!quizError && quizResults && quizResults.length > 0) {
        ...
        const updatedStats = {
          ...
          streak: stats.streak || 0, // Keep existing streak
        ...
        // Update the users table with calculated stats
        if (profileData) {
        ...
        // No quiz results, set default stats
        setStats({
          totalQuizzes: 0,
          bestScore: 0,
          averageScore: 0,
    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      <div className="glass-card p-6">
        ...
        {recentQuizzes.length === 0 ? (
          <p className="text-gray-400 text-center py-4">No quizzes taken yet. Start your first quiz!</p>
        ) : (
