...
export const categoryHierarchy = [
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'trivia', name: 'Trivia', icon: '🎯', color: 'text-blue-400', description: 'Fun facts and trivia', source: 'api', apiId: 9 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'modern-literature', name: 'Modern Literature', icon: '📕', color: 'text-blue-400', description: 'Contemporary books', source: 'api', apiId: 10 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'modern-films', name: 'Modern Films', icon: '📽️', color: 'text-blue-400', description: 'Contemporary cinema', source: 'api', apiId: 11 },
      { id: 'directors', name: 'Directors', icon: '🎥', color: 'text-purple-400', description: 'Famous directors', source: 'api', apiId: 11 },
      { id: 'actors', name: 'Actors', icon: '⭐', color: 'text-yellow-400', description: 'Famous actors', source: 'api', apiId: 11 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'jazz-music', name: 'Jazz Music', icon: '🎷', color: 'text-blue-400', description: 'Jazz music', source: 'api', apiId: 12 },
      ...
      { id: 'artists', name: 'Artists', icon: '⭐', color: 'text-yellow-400', description: 'Famous musicians', source: 'api', apiId: 12 },
  ...
  // ============================================
  {
    ...
    children: [
      { id: 'tv-shows', name: 'TV Shows', icon: '📺', color: 'text-blue-500', description: 'TV series', source: 'api', apiId: 14 },
      ...
      { id: 'animated-shows', name: 'Animated Shows', icon: '🧸', color: 'text-yellow-400', description: 'Animated TV series', source: 'api', apiId: 14 },
      { id: 'tv-history', name: 'TV History', icon: '📜', color: 'text-amber-400', description: 'Television history', source: 'api', apiId: 14 },
      { id: 'tv-personalities', name: 'TV Personalities', icon: '⭐', color: 'text-yellow-400', description: 'Famous TV hosts', source: 'api', apiId: 14 },
    ]
  },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'modern-games', name: 'Modern Games', icon: '🎯', color: 'text-blue-400', description: 'Current games', source: 'api', apiId: 15 },
      ...
      { id: 'esports', name: 'Esports', icon: '🏆', color: 'text-yellow-400', description: 'Competitive gaming', source: 'api', apiId: 15 },
    ]
  },
  ...
  // ============================================
  {
    ...
    children: [
      { id: 'computer-science', name: 'Computer Science', icon: '🖥️', color: 'text-blue-400', description: 'CS fundamentals', source: 'api', apiId: 18 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'algebra', name: 'Algebra', icon: '🔢', color: 'text-blue-400', description: 'Algebra concepts', source: 'api', apiId: 19 },
      ...
      { id: 'math-puzzles', name: 'Math Puzzles', icon: '🧩', color: 'text-yellow-400', description: 'Math brain teasers', source: 'api', apiId: 19 },
    ]
  },
  ...
  // ============================================
  {
    ...
    children: [
      { id: 'world-geography', name: 'World Geography', icon: '🌍', color: 'text-blue-400', description: 'General geography', source: 'api', apiId: 22 },
      { id: 'countries', name: 'Countries', icon: '🏳️', color: 'text-blue-300', description: 'Countries and cultures', source: 'api', apiId: 22 },
      ...
      { id: 'rivers', name: 'Rivers', icon: '🏞️', color: 'text-blue-400', description: 'Major rivers', source: 'api', apiId: 22 },
      { id: 'deserts', name: 'Deserts', icon: '🏜️', color: 'text-yellow-400', description: 'World deserts', source: 'api', apiId: 22 },
    ]
  },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'ancient-history', name: 'Ancient History', icon: '🏺', color: 'text-yellow-400', description: 'Ancient civilizations', source: 'api', apiId: 23 },
      ...
      { id: 'cold-war', name: 'Cold War', icon: '❄️', color: 'text-blue-400', description: 'Cold War era', source: 'api', apiId: 23 },
      { id: 'ancient-egypt', name: 'Ancient Egypt', icon: '🏺', color: 'text-amber-400', description: 'Egyptian civilization', source: 'api', apiId: 23 },
      { id: 'ancient-greece', name: 'Ancient Greece', icon: '🏛️', color: 'text-blue-400', description: 'Greek civilization', source: 'api', apiId: 23 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'world-politics', name: 'World Politics', icon: '🌍', color: 'text-blue-400', description: 'Global politics', source: 'api', apiId: 24 },
      ...
      { id: 'political-leaders', name: 'Political Leaders', icon: '👤', color: 'text-yellow-400', description: 'Famous leaders', source: 'api', apiId: 24 },
    ]
  },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'photography', name: 'Photography', icon: '📸', color: 'text-blue-400', description: 'Photography art', source: 'api', apiId: 25 },
  ...
  // ============================================
  {
    ...
    children: [
      { id: 'celebrities-trivia', name: 'Celebrities', icon: '⭐', color: 'text-yellow-400', description: 'Celebrity facts', source: 'api', apiId: 26 },
      ...
      { id: 'influencers', name: 'Influencers', icon: '📱', color: 'text-blue-400', description: 'Social media stars', source: 'api', apiId: 26 },
    ]
  },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'birds', name: 'Birds', icon: '🐦', color: 'text-blue-400', description: 'Bird species', source: 'api', apiId: 27 },
      ...
      { id: 'insects', name: 'Insects', icon: '🐝', color: 'text-yellow-400', description: 'Insect species', source: 'api', apiId: 27 },
    ]
  },
  ...
  // ============================================
  {
    ...
    children: [
      { id: 'vehicles-trivia', name: 'Vehicles', icon: '🚗', color: 'text-blue-600', description: 'Vehicle facts', source: 'api', apiId: 28 },
      ...
      { id: 'trucks', name: 'Trucks', icon: '🚚', color: 'text-blue-400', description: 'Truck models', source: 'api', apiId: 28 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'dc', name: 'DC Comics', icon: '🦸', color: 'text-blue-500', description: 'DC universe', source: 'api', apiId: 29 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'studio-ghibli', name: 'Studio Ghibli', icon: '🏠', color: 'text-blue-400', description: 'Ghibli films', source: 'api', apiId: 31 },
  ...
  // ============================================
  {
    ...
    children: [
      { id: 'cartoon-animation', name: 'Cartoons', icon: '🧸', color: 'text-yellow-500', description: 'Cartoon trivia', source: 'api', apiId: 32 },
      { id: 'disney', name: 'Disney', icon: '🏰', color: 'text-blue-400', description: 'Disney animation', source: 'api', apiId: 32 },
      { id: 'pixar', name: 'Pixar', icon: '💡', color: 'text-yellow-400', description: 'Pixar films', source: 'api', apiId: 32 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'cricket', name: 'Cricket', icon: '🏏', color: 'text-blue-400', description: 'Cricket trivia', source: 'api', apiId: 21 },
      { id: 'formula-1', name: 'Formula 1', icon: '🏎️', color: 'text-red-400', description: 'F1 racing', source: 'api', apiId: 21 },
      { id: 'olympics', name: 'Olympics', icon: '🏅', color: 'text-yellow-400', description: 'Olympic games', source: 'api', apiId: 21 },
      { id: 'baseball', name: 'Baseball', icon: '⚾', color: 'text-blue-400', description: 'Baseball trivia', source: 'api', apiId: 21 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'greek-mythology', name: 'Greek Mythology', icon: '⚡', color: 'text-yellow-400', description: 'Greek myths', source: 'api', apiId: 20 },
      { id: 'norse-mythology', name: 'Norse Mythology', icon: '🔨', color: 'text-blue-400', description: 'Norse myths', source: 'api', apiId: 20 },
      { id: 'world-religions', name: 'World Religions', icon: '🕊️', color: 'text-purple-400', description: 'Major religions', source: 'api', apiId: 20 },
      { id: 'christianity', name: 'Christianity', icon: '✝️', color: 'text-blue-300', description: 'Christian faith', source: 'custom', customId: 'bible-studies' },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'investing', name: 'Investing', icon: '📈', color: 'text-blue-400', description: 'Stocks and bonds', source: 'custom', customId: 'investing' },
      ...
      { id: 'leadership', name: 'Leadership', icon: '👤', color: 'text-yellow-400', description: 'Leadership skills', source: 'custom', customId: 'leadership' },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'stress-management', name: 'Stress Management', icon: '🧘', color: 'text-blue-400', description: 'Managing stress', source: 'custom', customId: 'stress-management' },
    ]
  },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'broadway', name: 'Broadway', icon: '🎭', color: 'text-yellow-400', description: 'Broadway shows', source: 'api', apiId: 13 },
      { id: 'west-end', name: 'West End', icon: '🎭', color: 'text-red-400', description: 'West End shows', source: 'api', apiId: 13 },
      { id: 'acting', name: 'Acting', icon: '🎭', color: 'text-blue-400', description: 'Acting techniques', source: 'api', apiId: 13 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'puzzles', name: 'Puzzles', icon: '🧩', color: 'text-yellow-400', description: 'Puzzle games', source: 'api', apiId: 16 },
    ]
  }
];
