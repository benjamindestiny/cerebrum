...
export const categoryHierarchy = [
  ...
  // ============================================
  {
    ...
    children: [
      { id: 'tv-shows', name: 'TV Shows', icon: '📺', color: 'text-blue-400', description: 'TV series', source: 'api', apiId: 14 },
  ...
  // ============================================
  {
    ...
    children: [
      ...
      { id: 'dc', name: 'DC Comics', icon: '🦸', color: 'text-blue-400', description: 'DC universe', source: 'api', apiId: 29 },
