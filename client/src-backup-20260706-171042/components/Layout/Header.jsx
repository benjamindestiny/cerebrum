...
import { 
  Brain, LayoutDashboard, Trophy, Puzzle, 
  User, Menu, X, FolderTree, BookOpen,
  LogIn, LogOut, UserCircle, Home
} from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-[#a78bfa] to-[#7c3aed] bg-clip-text text-transparent">
                Cerebrum
              </span>
            </div>
          </div>
