      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-gray-400 text-sm">
            ...
            <span className="text-gray-500 text-xs hidden sm:inline">Empowering Minds Through Knowledge</span>
          </div>
          ...
          <div className="flex items-center gap-6 flex-wrap justify-center">
            ...
            <Link to="/privacy" className="text-gray-400 hover:text-white transition-colors text-sm hover:underline">
              Privacy
            </Link>
            <Link to="/terms" className="text-gray-400 hover:text-white transition-colors text-sm hover:underline">
              Terms
            </Link>
            <a 
