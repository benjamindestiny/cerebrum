export const categories = [
  { id: 1, name: 'Technology', icon: '💻', color: 'text-blue-400', count: 45 },
  ...
  { id: 9, name: 'Ancient Civilizations', icon: '🏛️', color: 'text-yellow-400', count: 12, parent: 8 },
  ...
  { id: 15, name: 'Countries', icon: '🗺️', color: 'text-blue-300', count: 15, parent: 14 },
